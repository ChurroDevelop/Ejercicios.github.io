...
let puntuacion = parseFloat(prompt("Ingrese la puntuacion del trabajador"));
if (puntuacion > 0 && puntuacion < 0.4) {
    let sub = 2400 * puntuacion;
    let total = 2400 + sub;
    alert(`El trabajador gano ${total} este año con ${puntuacion} puntos`);
}
